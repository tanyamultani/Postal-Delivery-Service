/**
 * A class that inherits from class Package to create object with same attributes but of type Metal Crate with different methods 
 */
public class MetalCrate extends Package {
	 ...
	 * @param shippingCost
	 */
	public MetalCrate(int trackingNum, double weight, String type, double shippingCost) {
