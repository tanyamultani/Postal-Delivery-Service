/**
 * A class that inherits from class Package to create object with same attributes but of type Box with different methods 
 */
public class Box extends Package {
	 ...
	 * @param shippingCost
	 */
	public Box(int trackingNum, double weight, String type, double shippingCost) {
